...
>
  {(() => {
    const POSTS = [
      { id: "supabase-prototyping", title: "Supabase for Rapid Prototyping — A Hands-On Guide", date: "Aug 1", read: "5 min read", href: "#" },
      { id: "gpt-study-mode",       title: "ChatGPT “Study and Learn” — Deep Dive",               date: "Aug 1", read: "5 min read", href: "#", featured: true },
      { id: "tech-hiring",          title: "The Dark Side of Tech Hiring",                        date: "Jul 7", read: "5 min read", href: "#" },
      { id: "langchain-agents",     title: "Agents in LangChain: The Basics",                     date: "Jul 6", read: "4 min read",  href: "#" },
      { id: "agentic-workflows",    title: "Agentic Workflows in n8n: A Starter",                 date: "Jul 6", read: "4 min read",  href: "#" },
      { id: "finetuning-llms",      title: "Fine-Tuning LLMs in 2025",                            date: "Jul 6", read: "3 min read",  href: "#" },
    ];

    const BlogCard = ({ post }) => (
      <a href={post.href} className="block h-full">
        {/* Gradient hairline + hover lift */}
        <div className="relative h-full rounded-2xl bg-gradient-to-br from-sky-400/20 to-emerald-400/20 p-[1px] transition-transform duration-300 hover:-translate-y-1">
          ...
          <div className="h-55 rounded-2xl bg-zinc-950/70 backdrop-blur border border-zinc-800/80
            ...
            {/* spacer grows so the footer sticks to bottom */}
            <div className="flex-grow" />

            {/* Footer: date + read time in teal */}
